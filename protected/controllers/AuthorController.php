	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Author']))
		{
            ...
            if($model->born!=null)
                ...
                $model->born=null;
			if($model->save()){
                if(isset($newBooks)&&!empty($newBooks)){
                    foreach ($newBooks as $book){
                        $bookAuthor= new BookAuthor();
                        $bookAuthor->author_id=$model->id;
		...
		if(isset($_POST['Author']))
		{
			...
			if($model->save()){
                ...
                if(isset($newBooks)){
                    ...
                    $booksToDelete=implode(", ",array_diff($oldArr,$newBooks));
                    $booksToAdd=array_diff($newBooks, $oldArr);
                    ...
                    if(!empty($booksToDelete)){
                        ...
                        $criteria->addCondition("author_id in (:booksToDelete) and author_id=:author_id",array(':booksToDelete'=>$booksToDelete,':author_id'=>$model->id));
